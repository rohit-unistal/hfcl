...
public class LayingOfflineActivity extends AppCompatActivity {
   ...
   // private Intent serviceIntent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laying_offline);
    ...
    dataBaseHelper = new DataBaseHelper(context);
       ...
       // arrayNextLengthList= new ArrayList<>();
        ...
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(context, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(LayingOfflineActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
    ...
    public void getZone(){
       zoneList.clear();
        ...
        if (cur.getCount() > 0) {
            ...
            Toast.makeText(LayingOfflineActivity.this, "No Zone found or Please update details", Toast.LENGTH_SHORT).show();
        }
    ...
    public void getDMA(){
        ...
        if (cur.getCount() > 0) {
            ...
            Toast.makeText(LayingOfflineActivity.this, "No DMA found or Please update  details", Toast.LENGTH_SHORT).show();
        }
    ...
    private void setPipeType(){
       ...
       /* ArrayList<PipeModel.PipeSubType> pipeSubTypeList = new ArrayList<>();
        ...
        pipeDiumList.add( new PipeModel.PipeSubType.PipeDium("-1", "select"));
        pipeSubTypeList.add( new PipeModel.PipeSubType("-1","Select",pipeDiumList));
        PipeTypeDataList.add(new PipeModel("-1","Select",
               pipeSubTypeList));*/
        try {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        LayingOfflineActivity.super.onBackPressed();
                    }
                }).create().show();
    }
                ...
                if (flag) {
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                        ...
                        protected Map<String, String> getParams() {
                            ...
                            params.put("user_id", SessionUtil.getUserId(context));
                            params.put("zone", spinnerZone.getText().toString().trim()+ "");
                            params.put("dma", spinnerDMA.getText().toString().trim() + "");
                            params.put("pipe_number", spinpipesegment.getSelectedItem().toString().trim() + "");
                            params.put("start_node", spinnerStartNode.getText().toString().trim() + "");
                            params.put("end_node", spinnerEndNode.getText().toString().trim() + "");
