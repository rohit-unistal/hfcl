...
public class CreateGapActivity extends AppCompatActivity {
    ...
    ArrayAdapter pipeAdapter,zoneAdapter,reasonAdapter,dmaAdapter,contractorAdapter,networkAdapter;
    private static final int CAMERA_CAPTURE_IMAGE_REQUEST_CODE = 100;
    String image,dmaName ,pipeNumber="",pipeID="",contractorID, startNodeID="", endNodeID="",zoneName="",fittingID="",subfittingID="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_gap);
    ...
    public void init(){
        ...
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(context, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(CreateGapActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
    ...
    public void sheetSubmit() {
        if (validate()) {
            ...
            params.put("gap_date", editDate.getText().toString() + "");
            params.put("photo", filePath+ "");
            params.put("actual_gap", editLength.getText().toString()+ "");
            params.put("actual_length", editScope.getText().toString()+ "");
            params.put("contractor_id", contractorID+ "");

            Log.e("Pppppppppppppppppparams", params.toString());
            boolean s = dataBaseHelper.gapInsert(params);
            if (s) {
...
/*
            if (DialogUtil.checkInternetConnection(this)) {
                ...
                if (flag) {
                    ...
                    final String url = AppConstants.APP_BASE_URL + "insertGaps";
                    // Request a string response from the provided URL.
    ...
    public void getZone(){
        ...
        if (cur.getCount() > 0) {
            ...
            Toast.makeText(CreateGapActivity.this, "No Zone found or Please update  details", Toast.LENGTH_SHORT).show();
        }
    ...
    public void getDMA(){
        ...
        if (cur.getCount() > 0) {
            ...
            Toast.makeText(CreateGapActivity.this, "No dma found or Please update  details", Toast.LENGTH_SHORT).show();
        }
    ...
    private void setPipeNumber(){
        ...
        Cursor cur = dataBaseHelper.getAll("SELECT DISTINCT pipe_number,start_node,stop_node,scope,dma" +
    ...
    public boolean validate(){
        ...
        {
            valid = false;
            Toast.makeText(context,"Enter Gap Length",Toast.LENGTH_SHORT).show();
        }
    ...
    protected void onResume() {
        super.onResume();
        startLocationListener();
        serviceIntent = new Intent(CreateGapActivity.this, LocationService.class);
    ...
    public void captureStartImage() {
        ...
        if ((ActivityCompat.shouldShowRequestPermissionRationale(CreateGapActivity.this,
                Manifest.permission.WRITE_EXTERNAL_STORAGE)) && (ActivityCompat.shouldShowRequestPermissionRationale(CreateGapActivity.this,
            ...
            if (ContextCompat.checkSelfPermission(context,
                ...
                ActivityCompat.requestPermissions(CreateGapActivity.this,
